...
ALTER TABLE clients ADD CONSTRAINT uc_clients_cpf UNIQUE (cpf);
...
ALTER TABLE credit ADD CONSTRAINT FK_CREDIT_ON_CUSTOMER FOREIGN KEY (customer_id) REFERENCES clients (id);